...
class Engine {
  ...
  frobenius(n, a) {
    const F12 = [
      ...
      [
          [this.F1.one, this.F1.zero],
          [this.F1.constant(3850754370037169011952147076051364057158807420970682438676050522613628423219637725072182697113062777891589506424760n), this.F1.constant(151655185184498381465642749684540099398075398968325446656007613510403227271200139370504932015952886146304766135027n)],
          [this.F1.constant(793479390729215512621379701633421447060886740281060493010456487427281649075476305620758731620351n), this.F1.zero],
          [this.F1.constant(2973677408986561043442465346520108879172042883009249989176415018091420807192182638567116318576472649347015917690530n), this.F1.constant(1028732146235106349975324479215795277384839936929757896155643118032610843298655225875571310552543014690878354869257n)],
          [this.F1.constant(793479390729215512621379701633421447060886740281060493010456487427281649075476305620758731620350n), this.F1.zero],
          [this.F1.constant(3125332594171059424908108096204648978570118281977575435832422631601824034463382777937621250592425535493320683825557n), this.F1.constant(877076961050607968509681729531255177986764537961432449499635504522207616027455086505066378536590128544573588734230n)],
          [this.F1.constant(4002409555221667393417789825735904156556882819939007885332058136124031650490837864442687629129015664037894272559786n), this.F1.zero],
          [this.F1.constant(151655185184498381465642749684540099398075398968325446656007613510403227271200139370504932015952886146304766135027n), this.F1.constant(3850754370037169011952147076051364057158807420970682438676050522613628423219637725072182697113062777891589506424760n)],
          [this.F1.constant(4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939436n), this.F1.zero],
          [this.F1.constant(1028732146235106349975324479215795277384839936929757896155643118032610843298655225875571310552543014690878354869257n), this.F1.constant(2973677408986561043442465346520108879172042883009249989176415018091420807192182638567116318576472649347015917690530n)],
          [this.F1.constant(4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939437n), this.F1.zero],
          [this.F1.constant(877076961050607968509681729531255177986764537961432449499635504522207616027455086505066378536590128544573588734230n), this.F1.constant(3125332594171059424908108096204648978570118281977575435832422631601824034463382777937621250592425535493320683825557n)],
      ]
    ];
    ...
    const F6 = [
      ...
      [
        [this.F1.one, this.F1.zero],
        [this.F1.zero, this.F1.constant(4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939436n)],
        [this.F1.constant(793479390729215512621379701633421447060886740281060493010456487427281649075476305620758731620350n), this.F1.zero],
        [this.F1.zero, this.F1.one],
        [this.F1.constant(4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939436n), this.F1.zero],
        [this.F1.zero, this.F1.constant(793479390729215512621379701633421447060886740281060493010456487427281649075476305620758731620350n)],
      ],
      [
        [this.F1.one, this.F1.zero],
        [this.F1.constant(4002409555221667392624310435006688643935503118305586438271171395842971157480381377015405980053539358417135540939437n), this.F1.zero],
    ...
    for (let i=0; i<6; i++) {
        ...
        const i2 = i%3;
        const coef = this.F2.mul(F12[Math.floor(i/3)][n%12] , F6[i%3][n%6]);
        if (n%2 == 1) {
  ...
  pairingEquationCheck(p1, q1, p2, q2) {
    const q1Prep = this.prepareG2(q1);
    const q2Prep = this.prepareG2(q2);
    const m1 = this.miller_loop(p1, q1Prep);
    const m2 = this.miller_loop(p2, q2Prep);
    const m = this.F12.mul(m1, m2);
    const s =  this.finalExponentiation(m);
    this.F12.assertEqual(s, this.F12.one);
  }
}
